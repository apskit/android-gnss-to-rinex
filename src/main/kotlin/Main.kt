...
fun main(args: Array<String>) {
    ...
    val output by parser.option(ArgType.String, shortName = "o", description = "Path to RINEX output file").required()
    ...
    try {
        ...
        converter.convert(inputFile, outputFile, integerize, fixedBias)
